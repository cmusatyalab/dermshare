...
# a virtualenv located at /tmp/autosegment-$USERID/$(sha1sum file.zip) and
# installs the necessary Python dependencies. Finally, it runs the Diamond
# filter.
#
...
def make_user_tmpdir(system_tmp=None):
    ...
    tmpdir = os.path.join(system_tmp, "autosegment-%d" % os.getuid())
    try:
...
if __name__ == '__main__':
    ...
    from autosegment.__main__ import main
    main()
